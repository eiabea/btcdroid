...
public class WorkerListAdapter_old extends BaseExpandableListAdapter {

    private Context context;

    private List<Holder> holders = new ArrayList<WorkerListAdapter_old.Holder>();

    public WorkerListAdapter_old(Context context) {
